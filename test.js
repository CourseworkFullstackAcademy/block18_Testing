...
1. When a user clicks on checkout in shopping cart, they should be shown a prompt with options to check out as a guest, to create an account or to log in if they are not already logged in.
